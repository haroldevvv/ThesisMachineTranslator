...
FILE_PATH = "/ThesisMT/Datasets/augmented_data/augmented_data_for_direct_translation/rin_en_8.5k_augmented_NLLB200.csv"
MODEL_DIR = "/ThesisMT/direct_augmented_MT/models/NLLB200/runs/rin_en_3.5k_15epochs_nllb_offload_run-20251006-092653/final_model"
...
def prepare_dataset(file_path, tokenizer):
    ...
    assert "rin" in df.columns and "en" in df.columns, "CSV must have 'rin' and 'en' columns!"
    ...
    def preprocess(example):
        ...
        labels = tokenizer(example["en"], truncation=True, max_length=128)["input_ids"]
