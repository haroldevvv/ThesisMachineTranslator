...
def prepare_dataset(file_path, tokenizer):
    ...
    def preprocess(example):
        model_inputs = tokenizer(example["eng"], truncation=True)  
        labels = tokenizer(example["rin"], truncation=True)["input_ids"]  
...
def main():
    ...
    experiment_name = "en_rin_3.5k_20epochs_nllb_offload"  # updated name
