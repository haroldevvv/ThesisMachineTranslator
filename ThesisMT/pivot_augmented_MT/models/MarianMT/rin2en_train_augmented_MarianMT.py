...
file_path = "/ThesisMT/Datasets/augmented_data/augmented_data_for_pivot_translation/rin_en_8.5k_augmented_MarianMT.csv"
...
def main():
    ...
    experiment_name = "rin_en_8.5k_25epochs_MarianMT"
